...
getWeatherData()
function getWeatherData () { fetch(`https://api.openweathermap.org/data/2.5/forecast?lat=36.778259&lon=-119.417931&units=metric&appid=3a911854309296acd6a69c008192825b`).then(res => res.json()).then(data => {
